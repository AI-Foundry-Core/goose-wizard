...
Read `~/goose-wizard/progression.json` and check concept 6.1 (module 22: continuous-dev).
...
Update concept 6.1 (module 22: continuous-dev) in `~/goose-wizard/progression.json`:
