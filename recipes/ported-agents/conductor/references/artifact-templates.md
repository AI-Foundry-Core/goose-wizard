...
> **Lineage:** Ported from
> `~/ClaudeInfra/ril-agents/plugins/conductor/skills/context-driven-development/references/artifact-templates.md`.
> Preserved verbatim. Do not modify the lineage source.
