...
> **Lineage:** Ported from
> `~/ClaudeInfra/ril-agents/plugins/conductor/skills/context-driven-development/SKILL.md`.
> Frontmatter (`name:` / `version:`) stripped during port; body preserved
> verbatim. Do not modify the lineage source.
...
- Pin .goose/conductor/product.md for quick reference
