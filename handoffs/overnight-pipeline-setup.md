...
- [x] Flask cloned at `<PROJECTS>\MockTestTarget`
- [x] Goose installed at `<HOME>\.local\bin\goose.exe`
...
- [x] Codex at `<PROJECTS>\AgenticSystem\codex_review.py`
...
## Output Files (what Doni sees in the morning)
