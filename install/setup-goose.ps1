...
Write-Host "  open on the side for browsing recipe YAML files after each"
Write-Host "  module, but do NOT run recipes from the desktop app -"
Write-Host "  the CLI experience is what the training is designed for."
Write-Host ""
